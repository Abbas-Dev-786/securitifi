...
const Dashboard: React.FC = () => {
  ...
  const { properties, fetchUserProperties, loading } = usePropertyManager();
  ...
  }, [wallet.isConnected, fetchUserProperties]);
  ...
  const quickActions = [
    { title: 'Tokenize Property', icon: Building2, color: 'from-blue-500 to-cyan-500', href: '/properties' },
    { title: 'Request Loan', icon: Coins, color: 'from-purple-500 to-pink-500', href: '/lending' },
    { title: 'Bridge Assets', icon: Globe, color: 'from-green-500 to-emerald-500', href: '/bridge' },
    { title: 'View Portfolio', icon: Target, color: 'from-orange-500 to-red-500', href: '/portfolio' },
  ];
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl px-6 py-3 border border-gray-200 dark:border-gray-700 shadow-lg">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">
                {parseFloat(formatEther(wallet.balance || '0')).toFixed(4)} ETH
              </span>
            </div>
          </div>
      ...
      >
        ...
        <div className="space-y-4">
          {recentActivities.map((activity, index) => (
            ...
            >
              <div className="flex items-center space-x-4">
                <div className={`w-10 h-10 rounded-xl bg-gray-100 dark:bg-gray-600 flex items-center justify-center group-hover:scale-110 transition-transform ${
                  activity.type === 'mint' ? 'bg-blue-100 dark:bg-blue-900/30' :
                  activity.type === 'loan' ? 'bg-green-100 dark:bg-green-900/30' :
                  activity.type === 'rent' ? 'bg-purple-100 dark:bg-purple-900/30' :
