...
import { Building2, Shield, Coins, ArrowRight, Check, Star, TrendingUp, Users, Globe, Zap, Award, BarChart3 } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Convert real estate into digital tokens for fractional ownership and seamless trading on blockchain.',
    gradient: 'from-blue-500 to-cyan-500'
  },
  {
    icon: Shield,
    title: 'Secure & Verified',
    description: 'All properties undergo rigorous verification with blockchain-secured ownership records.',
    gradient: 'from-green-500 to-emerald-500'
  },
  {
    icon: Coins,
    title: 'DeFi Lending',
    description: 'Use property tokens as collateral to access instant liquidity through decentralized lending.',
    gradient: 'from-purple-500 to-pink-500'
  },
  {
    icon: TrendingUp,
    title: 'Cross-Chain Bridge',
    description: 'Transfer assets seamlessly between Ethereum, Polygon, and other supported networks.',
    gradient: 'from-orange-500 to-red-500'
  },
  {
    icon: BarChart3,
    title: 'Portfolio Analytics',
    description: 'Track performance with real-time analytics and comprehensive portfolio insights.',
    gradient: 'from-indigo-500 to-purple-500'
  },
  {
    icon: Globe,
    title: 'Global Access',
    description: 'Invest in real estate worldwide with 24/7 trading and instant settlement.',
...
const testimonials = [
  {
    ...
    content: 'SecuritiFi revolutionized how I invest in real estate. The tokenization process is seamless and the returns are impressive.',
    rating: 5
  },
  {
    ...
    content: 'The platform made it easy to raise capital for my developments. The blockchain verification gives investors confidence.',
    rating: 5
  },
  {
    name: 'Emily Johnson',
    ...
    content: 'Finally, a way to combine real estate with DeFi. The lending features are game-changing for liquidity access.',
    rating: 5
  }
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950">
        ...
        <nav className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Real Estate DeFi</p>
            </div>
          </motion.div>
          ...
          >
            <div className="hidden md:flex items-center space-x-6 text-sm font-medium">
              ...
              <a href="#stats" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Stats</a>
            ...
            >
              <span>{wallet.isConnecting ? 'Connecting...' : 'Launch App'}</span>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-gray-200 dark:border-gray-700">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Powered by Blockchain Technology</span>
              </div>
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
                ...
                <span className="bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent"> Liquidity</span>
              </h1>
              
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed max-w-2xl">
                Transform real estate investment with cutting-edge blockchain technology. Tokenize properties, 
                access DeFi lending, and trade fractional ownership across multiple chains with institutional-grade security.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                >
                  <span>{wallet.isConnecting ? 'Connecting...' : 'Start Investing'}</span>
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-secondary-300/30 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-accent-300/30 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '4s' }}></div>
        </div>
      </section>

      {/* Stats Section */}
      <section id="stats" className="py-20 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border-y border-gray-200/50 dark:border-gray-700/50">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-primary-50 dark:bg-primary-900/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium text-primary-700 dark:text-primary-300">Industry Leading Features</span>
            </div>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Comprehensive tools and features designed to revolutionize how you invest, 
              trade, and manage real estate assets in the decentralized economy.
            </p>
          </motion.div>
      ...
      <section id="testimonials" className="py-20 bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-primary-900/10 dark:to-secondary-900/10">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join thousands of investors who are already tokenizing their real estate assets 
              and accessing unprecedented liquidity in the DeFi ecosystem.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <span>{wallet.isConnecting ? 'Connecting...' : 'Start Your Journey'}</span>
                <ArrowRight className="w-5 h-5" />
              </button>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                ...
                Building the future of property ownership and liquidity.
              </p>
              <div className="flex items-center space-x-4">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-400 mb-4 md:mb-0">
              © 2024 SecuritiFi. All rights reserved. Built with ❤️ for the future of real estate.
            </div>
